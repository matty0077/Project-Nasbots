...
class NNClassifier(object):
    ...
    def __init__(self):
        for i in range(10):
            with open('/home/pi/Desktop/NAVI/memory/DATA/ARM/vals%d.dat' % i, 'ab') as f: pass
        self.read_data()

    def store_data(self, cls, vals):
        with open('/home/pi/Desktop/NAVI/memory/DATA/ARM/vals%d.dat' % cls, 'ab') as f:
    ...
    def read_data(self):
        ...
        Y = []
        for i in range(10):
            X.append(np.fromfile('/home/pi/Desktop/NAVI/memory/DATA/ARM/vals%d.dat' % i, dtype=np.uint16).reshape((-1, 8)))
